  ...
  React.useEffect(() => {
    ...
    gsap.fromTo(
      ...
      },
      {
        ...
        boxShadow: '20px 20px 50px 15px rgba(1,1,1,0.5)',
        scrollTrigger: {
          trigger: sectionRef.current,
          start: 'top 80%',
          toggleActions: 'play none none reverse',
  ...
  return (
    ...
    >
      ...
      <div className='container top-0 mx-auto px-4 relative z-10 '>
        ...
        >
          TEST
        </h2><div ref={titleLineRef} className='w-0 h-2 bg-gradient-to-r from-purple-500 to bg-pink-500 mx-auto' />
      </div>
      <div ref={triggerRef} className='overflow-hidden'>
        <div ref={horizontalRef} className='horiontal-section flex md:w-[400%] w-[420%]'>
